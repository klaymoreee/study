...
for guide in guides:
    if guide_pk == guide["pk"]:
        session_data.append([guide["fields"]["full_name"], guide["fields"]["tours_count"], guide["fields"]["bio"]])
        
for infomation in session_data:
    print(f'''{infomation[0]}, туров: {infomation[1]}
{infomation[2]}''')